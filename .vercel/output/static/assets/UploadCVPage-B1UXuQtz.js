import{j as e,f as O,T as A}from"./ui-vendor-DmnzVvUC.js";import{r as E,u as w}from"./react-vendor-CGj_E3sL.js";import{u as R,p as x}from"./pdf-BZ-G6Gu4.js";import{a as D,t as g}from"./index-BEFO6H8i.js";import{A as P}from"./AnalysisAnimation-k7GG13EW.js";import{P as U}from"./PartnerLayout-D4MA7B5L.js";import"./tslib.es6-CiBE_y40.js";import"./___vite-browser-external_commonjs-proxy-BrL237SC.js";import"./LanguageSwitcher-DYMuky2f.js";import"./index-DlQgVf6T.js";x.GlobalWorkerOptions.workerSrc=`https://cdnjs.cloudflare.com/ajax/libs/pdf.js/${x.version}/pdf.worker.min.js`;const L=async p=>{const i=await p.arrayBuffer(),s=await x.getDocument(i).promise;let a="";for(let o=1;o<=s.numPages;o++){const u=await(await s.getPage(o)).getTextContent();a+=u.items.map(l=>"str"in l?l.str:"").join(" ")+`
`}return a},W=()=>{const[p,i]=E.useState(!1),[s,a]=E.useState(null),o=w(),{t:r}=D(),u=c=>{localStorage.setItem("cv_data",JSON.stringify(c)),o("/partner/builder/new",{state:{uploadedData:c}})},l=async c=>{var h;const d=c[0];if(!d)return;i(!0),a(null);const y=`Tu es une IA spécialisée dans l'analyse, l'extraction et la structuration de CV pour une application de carrière appelée Studyia Career.
