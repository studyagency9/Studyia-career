import{r as E,b as O,a as A,j as e,T as R,t as g}from"./index-Bj1s_XcD.js";import{u as w,C as D,p as x}from"./pdf-D778lf5l.js";import{A as P}from"./AnalysisAnimation-DDNIiVMl.js";import{P as U}from"./PartnerLayout-BgbMYxUy.js";import"./tslib.es6-CiBE_y40.js";import"./___vite-browser-external_commonjs-proxy-cjpsf4tL.js";import"./file-text-o8_AlPxW.js";import"./proxy-iKs4YyP_.js";import"./index-CKzmga31.js";import"./index-VZFS3j2r.js";import"./chevron-right-B_YPOfBq.js";import"./globe-CQwUOuMR.js";import"./upload-D3fRU1Y5.js";import"./sparkles-4mPYkMR5.js";x.GlobalWorkerOptions.workerSrc=`https://cdnjs.cloudflare.com/ajax/libs/pdf.js/${x.version}/pdf.worker.min.js`;const L=async p=>{const i=await p.arrayBuffer(),s=await x.getDocument(i).promise;let a="";for(let o=1;o<=s.numPages;o++){const u=await(await s.getPage(o)).getTextContent();a+=u.items.map(l=>"str"in l?l.str:"").join(" ")+`
`}return a},Y=()=>{const[p,i]=E.useState(!1),[s,a]=E.useState(null),o=O(),{t:r}=A(),u=c=>{localStorage.setItem("cv_data",JSON.stringify(c)),o("/partner/builder/new",{state:{uploadedData:c}})},l=async c=>{var h;const d=c[0];if(!d)return;i(!0),a(null);const y=`Tu es une IA spécialisée dans l'analyse, l'extraction et la structuration de CV pour une application de carrière appelée Studyia Career.
